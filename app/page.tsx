...
import AnimatedBoxes from "@/components/AnimatedBosex"
        ...
        <div className="container relative z-10 px-4 mx-auto">
          ...
          >
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold mb-4 bg-clip-text text-transparent bg-gradient-to-r from-purple-400 via-pink-500 to-red-500">
              Hey! It's Ratnesh Kurmi
            </h1>
            <h2 className="text-xl md:text-2xl mb-8 text-gray-300">
              🚀 Mern Stack Developer| Software Developer | Tech Explorer
            </h2>
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              <ProjectCard
                ...
                tags={["Next.js", "Firebase", "Arweave", "Web3"]} image={undefined}              />
              <ProjectCard
      ...
      <footer className="py-12 bg-gradient-to-t from-gray-900 to-black">
        <div className="container px-4 mx-auto">
          <div className="flex flex-wrap justify-center gap-6 mb-8">
            <SocialIcon icon={<Github />} href="https://github.com/ratneshpatelr" label="GitHub" />
            <SocialIcon icon={<Linkedin />} href="https://www.linkedin.com/in/ratnesh-kurmi-064682240/" label="LinkedIn" />
            <SocialIcon icon={<Twitter />} href="https://x.com/RatneshPat76900" label="Twitter" />
            <SocialIcon
              icon={<Smartphone />}
              href="#"
              label="Mobile Apps"
          ...
          <div className="text-center text-gray-500 text-sm">
            <p>© {new Date().getFullYear()} ratnesh kurmi. All rights reserved.</p>
            <ContactEmail />
          </div>
        </div>
      </footer>
...
function ContactEmail() {
  return (
    <div className="mt-2">
      <a href="mailto:ratneshpatel8815@gmail.com" className="text-purple-400 hover:text-purple-300">
