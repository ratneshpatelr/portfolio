...
import sarvalogo from "@/public/sarva.jpg"
import prathamlogo from "@/public/pratham.jpg"
import ttblogo from "@/public/ttb.png"
...
const timelineData = [
  {
    ...
    type: "Intern",
    logo: {ttblogo},
    skills: ["JavaScript", "React", "Redux-toolkit", "Nextjs"],
  },
  {
    id: 2,
    company: "Sarva Suvidhean pvt. Limited",
  ...
  {
    id: 3,
    company: "Pratham Softcon pvt. Limited",
    role: "Reactjs Developer",
    period: "Feb-2025 - Present",
    location: "Bhopal MP (Onsite)",
    type: "Full Time",
    logo: {prathamlogo},
    skills: ["React", "Next.js", "Tailwind CSS"],
  },
            ...
            <div className="md:w-2/3">
              <div className="prose prose-invert max-w-none text-center md:text-left">
                ...
                <p className="text-lg leading-relaxed md:hidden">
                  Mern Stack and Reactjs developer💻. Building secure, scalable solutions in the
                  User Interfaces. From static to Dynamic, turning complex tech into seamless experiences. ⛓⚡🔥
                </p>
                {/* Desktop description */}
                <div className="hidden md:block">
                  <p className="text-xl mb-4">
                    🚀 <strong>Hey, I'm Ratnesh Kurmi!</strong>
                  </p>
                  <p className="mb-4">
                    A <strong>Mern stack 🧙‍♂️</strong> and <strong>AI intregration with Front-end 💻</strong>, turning{" "}
                  ...
                  <p className="mb-4">
                  I spend my days <strong>building web apps with React.js, Node.js, and the MERN stack</strong>—and my nights diving 
                  into <strong>AI innovations</strong> and exploring new ways to integrate intelligent solutions. When I'm not coding,
                   I'm probably tinkering with <strong>open-source projects</strong> or evangelizing AI-driven web development to 
