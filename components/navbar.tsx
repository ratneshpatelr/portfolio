  ...
  return (
    ...
    >
      <div className="container mx-auto px-4 md:px-8 flex justify-between items-center">
        <Link href="#home" className="text-2xl font-bold text-white border-b-4 border-b-blue-900" onClick={(e) => scrollToSection(e, "#home")}>
        Ratnesh<span className="text-red-500"> Kurmi.</span>
        </Link>
