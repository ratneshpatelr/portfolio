...
function Particles({ count = 5000 }) {
  ...
  return (
    <instancedMesh ref={mesh} args={[undefined, undefined, count]} material={ParticlesMaterial}>
      <bufferGeometry>
        <bufferAttribute attach="attributes-position" count={positions.length / 3} array={positions} itemSize={3} args={[]} />
        <bufferAttribute attach="attributes-scale" count={scales.length} array={scales} itemSize={1} args={[]} />
      </bufferGeometry>
    </instancedMesh>
  )
}
